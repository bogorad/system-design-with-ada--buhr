...
This repository contains digitized chapters of the book "System Design with Ada" taken from [The Internet Archive](https://archive.org/details/systemdesignwith0000buhr)
...
_Note: This script requires `pandoc` to be installed. On NixOS, you can run it via:_
